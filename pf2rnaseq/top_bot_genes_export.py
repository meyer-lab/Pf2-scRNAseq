...
def export_genes_to_csv(
    X, output_path="component_genes.csv", components=range(1, 31), geneAmount=30
):
    """
...
export_genes_to_csv(
    X, output_path="component_genes.xlsx", components=range(1, 31), geneAmount=30
)
